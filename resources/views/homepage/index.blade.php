...
<head>
    ...
    <link href="{{ asset('static/css/style.default.css') }}" rel="stylesheet" id="theme-stylesheet">
                    ...
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand home" href="index.html">
                                <img src="{{ asset('static/img/logo.png') }}" alt="Universal logo" class="hidden-xs hidden-sm">
                                <img src="{{ asset('static/img/logo-small.png') }}" alt="Universal logo" class="visible-xs visible-sm"><span class="sr-only">Universal - go to homepage</span>
                            </a>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <div class="yamm-content">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <img src="{{ asset('static/img/template-easy-customize.png') }}" class="img-responsive hidden-xs" alt="">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <h5>Shortcodes</h5>
                                                        <ul>
            ...
            <div class="container">
                    ...
                    <div class="blog-entries">
                        <div class="item same-height-row clearfix">
                            <div class="image same-height-always">
                                <a href="#">
                                    <img class="img-responsive" src="{{ asset('static/img/detailsquare.jpg') }}" alt="">
                                </a>
                            </div>
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="photostream">
                        <div>
                            <a href="#">
                                <img src="{{ asset('static/img/detailsquare.jpg') }}" class="img-responsive" alt="#">
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <img src="{{ asset('static/img/detailsquare2.jpg') }}" class="img-responsive" alt="#">
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <img src="{{ asset('static/img/detailsquare3.jpg') }}" class="img-responsive" alt="#">
                            </a>
                        </div>
                        <div>
                            <a href="#">
...
_________________________________________________________ -->
    ...
    <script src="{{ asset('static/js/jquery.parallax-1.1.3.js') }}"></script>
